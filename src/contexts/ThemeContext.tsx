...
export const translations = {
  en: {
    ...
    viewManagePastConversions: 'View and manage your past file conversions',
    recentConversions: 'Recent Conversions',
    trackConversionActivities: 'Track all your file conversion activities',
    searchByFilename: 'Search by filename or format...',
    all: 'All',
    failed: 'Failed',
    clearAll: 'Clear All',
    refresh: 'Refresh',
    ...
    startConvertingFiles: 'Start converting files to see your history here.',
    loadingHistory: 'Loading history...',
    fetchingHistory: 'Please wait while we fetch your conversion history.',
    fileName: 'File Name',
    ...
    convertBetweenFormats: 'Convert between multiple document formats with ease',
    dragDropOrClick: 'Drag and drop files or click to browse. Supports multiple formats.',
    ...
    filesReadyForDownload: 'files ready for download',
  ...
  ur: {
    ...
    // History Page
    conversionHistory: 'تبدیلی کی تاریخ',
    viewManagePastConversions: 'اپنی پچھلی فائل تبدیلیوں کو دیکھیں اور منظم کریں',
    recentConversions: 'حالیہ تبدیلیاں',
    trackConversionActivities: 'اپنی تمام فائل تبدیلی سرگرمیوں کو ٹریک کریں',
    searchByFilename: 'فائل نام یا فارمیٹ کے ذریعے تلاش کریں...',
    all: 'تمام',
    failed: 'ناکام',
    clearAll: 'سب صاف کریں',
    refresh: 'تازہ کریں',
    noConversionsFound: 'کوئی تبدیلیاں نہیں ملیں',
    tryAdjustingSearch: 'اپنے تلاش یا فلٹر کے معیار کو ایڈجسٹ کرنے کی کوشش کریں۔',
    startConvertingFiles: 'اپنی تاریخ دیکھنے کے لیے فائلیں تبدیل کرنا شروع کریں۔',
    loadingHistory: 'تاریخ لوڈ ہو رہی ہے...',
    fetchingHistory: 'براہ کرم انتظار کریں جبکہ ہم آپ کی تبدیلی کی تاریخ حاصل کرتے ہیں۔',
    ...
    // Converter Page additional
    documentConverter: 'دستاویز کنورٹر',
    convertBetweenFormats: 'متعدد دستاویزی فارمیٹس کے درمیان آسانی سے تبدیل کریں',
    dragDropOrClick: 'فائلیں گھسیٹیں اور چھوڑیں یا براؤز کرنے کے لیے کلک کریں۔ متعدد فارمیٹس کی حمایت کرتا ہے۔',
    dropFilesHere: 'فائلیں یہاں چھوڑیں!',
    selectedFiles: 'منتخب فائلیں',
    clearAllFiles: 'سب صاف کریں',
    smartSuggestions: 'سمارٹ تجاویز',
    convertingFiles: 'فائلیں تبدیل ہو رہی ہیں...',
    pleaseWait: 'براہ کرم انتظار کریں جبکہ ہم آپ کی فائلوں پر کارروائی کرتے ہیں',
    convertedFiles: 'تبدیل شدہ فائلیں',
    filesReadyForDownload: 'فائلیں ڈاؤن لوڈ کے لیے تیار ہیں',
    downloadAll: 'سب ڈاؤن لوڈ کریں',
    conversionSummary: 'تبدیلی کا خلاصہ',
    avgTime: 'اوسط وقت',
    from: 'سے',
    includeMetadata: 'میٹا ڈیٹا شامل کریں',
